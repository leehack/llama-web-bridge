...
// runtime. This function and llamadart_webgpu_lora_adapter_init are the only
// ones linked with catching enabled (EXCEPTION_CATCHING_ALLOWED in
// CMakeLists.txt), which keeps the cost off every other code path, grammar
// sampling included. The throw unwinds straight
